# k-Nearest Neighbor Multiclass Classifier in Scikit-Learn with LIME explanations
## Project Description
...
- A **k-Nearest Neighbor Multiclass Classifier** algorithm built using **SciKit-Learn**
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the k-Nearest Neighbor Multiclass Classifier model implemented using **Scikit-Learn** library.
