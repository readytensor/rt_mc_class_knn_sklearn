        ...
        **kwargs,
        ...
        Args:
            n_neighbors (int, optional): Number of neighbors to use by default
                ...
                Defaults to 2.
            weights (int, optional): Weight function used in prediction that
                determines how the points are weighted.
                Options: ["uniform", "distance"]
                Defaults to "uniform".
            p (int, optional): Power parameter for the Minkowski metric.
                Defaults to 2.
            leaf_size (int, optional): The number of leaves used in construction
                for either ball_tree or kd_tree.
                Defaults to 5.
        """
